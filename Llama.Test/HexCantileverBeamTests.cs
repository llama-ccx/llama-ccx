...
namespace Llama.Test
{
    public class HexCantileverBeamTests
    {
        ...
        public void BuildInputDeck_HexCantileverWithTipLoad_ShouldContainExpectedCards()
        {
            ...
            Assert.Contains("*NODE PRINT,NSET=ROOT_FIX", deck);
        ...
        public void BuildAndRun_HexCantileverWithTipLoad_ShouldGenerateResultFiles()
        {
            ...
            {
                // Enable with LLAMA_RUN_CALCULIX_INTEGRATION=1.
                return;
            }
        ...
        {
            var runFlag = Environment.GetEnvironmentVariable("LLAMA_RUN_CALCULIX_INTEGRATION");
        ...
        private static StructuralModel CreateHexCantileverBeamModel()
        {
            ...
            step.OutputRequests.Add(StepOutputRequest.NodePrint("ROOT_FIX", NodalOutputVariable.RF));
