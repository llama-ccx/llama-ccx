...
namespace Llama.Gh.Components
{
    public class BuildInputDeckComponent : GH_Component
    {
        public BuildInputDeckComponent()
            : base("BuildInputDeck", "BuildInp", "Build and optionally write a CalculiX input deck from StructuralModel.", "Llama", "Application")
        {
            Message = Name + "\nLlama";
        }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Job Name", "Job", "Job name used for the .inp filename.", GH_ParamAccess.item, "Llama");
        }
        ...
        private string ResolveDefaultDirectory(string jobName)
        {
            ...
            return Path.Combine(Path.GetTempPath(), "Llama", jobName);
        }
