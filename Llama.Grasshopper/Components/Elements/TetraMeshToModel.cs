    ...
    public class TetraMeshComponent : GH_Component
    {
        public TetraMeshComponent()
            : base(
                "TetraMesh",
                "TetMesh",
                "Create a Llama tetra mesh definition from Rhino tetra meshes (V:4, F:4). " +
        ...
        {
            pManager.AddGenericParameter("TetraMesh", "Tet", "Llama tetra mesh definition (C3D10).", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (materialObj != null)
            {
                ...
                {
                    AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Material input must be a Llama MaterialBase.");
                    return;
                }
            }
