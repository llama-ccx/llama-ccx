...
namespace Llama.Gh.Conversion
{
    /// <summary>
    /// Converts Rhino tetra meshes (4 corner vertices) into Llama Tetra10 elements.
    /// Midside nodes are generated on the 6 topological edges.
    /// Duplicate nodes are merged by coordinate tolerance.
    /// </summary>
    public static class RhinoTetraMeshToLlamaConverter
    {
